 ...
 */
function old_city_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function old_city_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function old_city_button($element) {
...
*/
function old_city_img_assist_page($content, $attributes = NULL) {
